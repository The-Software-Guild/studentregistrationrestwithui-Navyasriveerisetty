$(document).ready(function() {
    ...
    $('#studentTable').on('click', 'button[id="delete"]', function(e) {
        ...
        $.ajax({
            ...
            success: function(id) {
                ...
                alertUsing("Selected student has been deleted successfully!", true);
                assignDataToTable();
            },
            error: function() {
                alert('FAILURE to delete student!');
            }
        });
    });
    ...
    // function to save student from form
    $("button#addStudent").click(function(event) {
        ...
        $.ajax({
            ...
            success: function(student) {
                alertUsing(student.name + " added successfully!", true);
                assignDataToTable();

            },
            error: function() {
                alertUsing("Please fill all the requirements and try again!", false);
            }
        });
    });
     ...
     $("button#search").click(function(e) {
        ...
        $.ajax({
            type: 'GET',
            url: 'http://localhost:8888/students/name/' + name,
            success: function(studentArray) {
                    ...
                    $("#studentTable>tbody").html(studentsData);
            },
            error: function() {
